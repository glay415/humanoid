...
- **상태 포화 캘리브레이션(T1)** — C1: 멀티세션서 bonding/arousal 1.0 clamp 천장. 사람-felt register 붕괴(세션2~) 와 동시점. InternalState Δmax/clamp·W·D 게인·state_reactivity 누적·EmotionBase arousal 식 재조정. Phase 6 의 구체 1순위.
